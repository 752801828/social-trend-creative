...
class TrendServiceTests(unittest.TestCase):
    ...
    def test_each_pipeline_stage_has_a_distinct_prompt(self):
        ...
        self.assertIn("abstract patterns, original comic-style scenes", classify_prompt)
        ...
        self.assertIn("original comic illustration", pool_prompt)
        self.assertIn("does not need to be inherently printable", pool_prompt)
