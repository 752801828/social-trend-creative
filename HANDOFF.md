...
3. 图案提取：把全部原始热点分批转译为安全、原创、可复用、与产品无关的抽象纹样、漫画插画、符号图形、几何构成或其他视觉方向，写入 `trends`；不要求热点本身是印花题材。
...
- 第二阶段默认尝试转译每个热点，可使用抽象、漫画、符号、几何、装饰或海报式表达；只有无法通过克制的非字面表达脱离商标、版权角色、真人肖像、仇恨符号、成人/暴力内容、错误信息或对受害者不尊重的方向才不进入可用图案池。
